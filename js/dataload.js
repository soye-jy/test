...
function imgUpload1() {
  $.ajax({
    type:"GET",
    url: "https://raw.githubusercontent.com/showhisper2/yummy/master/json/data_kwang.json",
    async:false,
...
function imgUpload2() {
  $.ajax({
    type:"GET",
    url: "https://raw.githubusercontent.com/showhisper2/yummy/master/json/data_yoons.json",
    async:false,
    success: function(json){
        all_list = saveImg_All(json);
        detec_face = saveImg_face(json);
...
function imgUpload3() {
  $.ajax({
    type:"GET",
    url: "https://raw.githubusercontent.com/showhisper2/yummy/master/json/data_pasta.json",
    async:false,
    success: function(json){
